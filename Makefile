...
MyLatte/Abs.hs MyLatte/Lex.x MyLatte/Par.y MyLatte/Print.hs MyLatte/Test.hs Main.hs Types.hs Interpreter.hs Typedefs.hs Utils.hs:  myLatte.cf
...
Main : MyLatte/Abs.hs MyLatte/Lex.hs MyLatte/Par.hs MyLatte/Print.hs Exception.hs Interpreter.hs Types.hs Main.hs Typedefs.hs Utils.hs
	${GHC} ${GHC_OPTS} $@
